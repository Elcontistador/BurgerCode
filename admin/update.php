<?php
    ...
    //     if(empty($name)) {
    //         $nameError = "Tu n'as pas mis de nom au produit.";
    //         $isSuccess = false;
    //     }
    //     if(empty($description)) {
    //         $descriptionError = "Tu n'as pas mis la description du produit.";
    //         $isSuccess = false;
    //     } 
    //     if(empty($price)) {
    //         $priceError = "Tu ne vas pas gagner ta vie si c'est gratuit !!!";
    //         $isSuccess = false;
    //     } 
    //     if(empty($category)) {
    //         $categoryError = "Tu dois donner une catégorie à ton produit.";
    //         $isSuccess = false;
    //     }
    ...
    //             $imageError = "Les seuls fichiers autorises sont: .jpg, .jpeg, .png, .gif";
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form class="form" action="<?php echo 'update.php?id='.$id;?>" role="form" method="post" enctype="multipart/form-data">
                        ...
                        <label class="form-label" for="price">Prix: (en €)</label>
                            <input type="number" step="0.10" class="form-control" id="price" name="price" placeholder="Prix" value="<?php echo number_format((float)$price, 2, '.', '');?>">
                ...
                <div class="col-md-6 site">
                    <div class="img-thumbnail">
                        <img src="<?php echo '../images/'.$image;?>" alt="image">
